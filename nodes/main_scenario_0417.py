...
def EgocentricBehaviour(currentElements, robotTaskNumber):
	...
	print ("\\rspd=90\\ can you move " + str(secondValue) + " beads to my right?")
	communicate.say (" Can you move " + str(secondValue) + " beads to my right")
...
def AddresseeBehaviour(currentElements, robotTaskNumber):
	...
	print ("\\rspd=90\\ can you move " + str(secondValue) + " beads to your right?")
	communicate.say (" Can you move " + str(secondValue) + " beads to your right")
...
def ChildTurnResponseScenario(dict_key, if_wait, childTurnOrder, productionBatch, childTaskNumber):
	...
	if current_action_dict [dict_key] == "WAIT":
		...
		#---------------------------------------------------
		if robot_answers_dict[childTurnOrder]:
		...
		elif not (robot_answers_dict[childTurnOrder]):
...
def RobotUtterances(interactionPoint):
	...
	if randomNum == 1:
		...
		ifwaitWords = "\\rspd=80\\ Aha , you mean like this?"
		secondWords = ""
		lastwords = "\\rspd=80\\ I hope I did a good job"
		nextwords = "\\rspd=80\\ Let's do the ext question"
	...
	if randomNum == 2:
		...
		nextwords = "\\rspd=80\\ moving on to next question"
	...
	if randomNum == 3:
		...
		secondWords = ""
		lastwords = "\\rspd=80\\ I am ready for the next one"
		nextwords = "\\rspd=80\\ "
