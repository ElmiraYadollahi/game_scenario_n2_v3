...
def GoToFinishLine(once):
	...
	if once == 1:
		...
		"""story.say("\\rspd=80\\ Thank you ")
		story.say("\\rspd=80\\ you read it so good")
		story.say("\\rspd=80\\ I loved reading with you")
		story.say("\\rspd=80\\ have a nice day and see you soon")"""
