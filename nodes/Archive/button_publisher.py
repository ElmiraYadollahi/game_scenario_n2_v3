...
def storySelection2(storyNum):
	...
	"""if len(msg.data) == 0 or not KEY_MAPPING.has_key(msg.data[0]):
		return
	reac = KEY_MAPPING[msg.data[0]]
	print KEY_MAPPING[msg.data[0]]k = 0 k = k = 0 k = 0 k = 0 0 """
...
def createButton():
	...
	storyAddress1 = "/home/yadollah/catkin_ws/src/story_reading_blunder/story_reading_nao/photos/" + str(storyString) + "_scale1.png"
	storyAddress2 = "/home/yadollah/catkin_ws/src/story_reading_blunder/story_reading_nao/photos/" + str(storyString) + "_scale2.png"
	storyAddress3 = "/home/yadollah/catkin_ws/src/story_reading_blunder/story_reading_nao/photos/" + str(storyString) + "_scale3.png"
	...
	button1 = Button(app, text="Task 3", height=2, width=15, activebackground="green", bg="grey", font="bold")
	#button2.grid(row=3, column=1)
	button1.pack(side="bottom", expand=False, padx=4, pady=4)

	button2 = Button(app, text="Task 2", height=2, width=15, activebackground="red", bg="grey", font="bold")
	#button1.grid(row=3, column=2)
	button2.pack(side="bottom", expand=False, padx=4, pady=4)

	button3 = Button(app, text="Task 1", height=2, width=15, activebackground="yellow", bg="grey", font="bold")
	#button2.grid(row=3, column=1)
	...
	button1.bind('<Button-1>', clickButtonTask1)
	button2.bind('<Button-1>', clickButtonTask2)
	button3.bind('<Button-1>', clickButtonTask3)

	root.mainloop()

def clickButtonTask1(event):
	#String = 'g'
	button_pub_wrong.publish("g")

def clickButtonTask2(event):
	#String = 'g'
	button_pub_start.publish("s")

def clickButtonTask3(event):
	#String = 'g'
	button_pub_start.publish("r")
